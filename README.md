...
docker run -d -v /tmp/.X11-unix:/tmp/.X11-unix:ro -e DISPLAY --privileged \
  braintwister/ubuntu-18.04-cmake-3.14-gcc-7-conan-1.12-docker-18.09-eclipse-cpp-2019-03
```
...
services:
  ...
  eclipse:
    image: braintwister/ubuntu-18.04-cmake-3.14-gcc-7-conan-1.12-docker-18.09-eclipse-cpp-2019-03
    volumes:
